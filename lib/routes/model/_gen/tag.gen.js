            ...
            if(!req.tag){
                ...
                //return next(new Error('Tag not found'));
					...
					if(!_.isUndefined(req.body.type)){
                        var type = xssFilters.inHTMLData(req.body.type);
					...
					if(!_.isUndefined(req.body.sub_type)){
                        var sub_type = xssFilters.inHTMLData(req.body.sub_type);

                    	req.tag.sub_type = sub_type;
					}
                
            
                
					if(!_.isUndefined(req.body.value)){
                        var value = xssFilters.inHTMLData(req.body.value);
					...
					if(!_.isUndefined(req.body.entity_type)){
                    	...
                    	req.tag.entity_type = entity_type;
					}
					...
					if(!_.isUndefined(req.body.entity_id)){
                    	...
                    	req.tag.entity_id = entity_id;
					}
                
            
                
					if(!_.isUndefined(req.body._entity_name)){
                        var _entity_name = xssFilters.inHTMLData(req.body._entity_name);

                    	req.tag._entity_name = _entity_name;
					}
                
            
                
					if(!_.isUndefined(req.body._entity_namespace)){
                        var _entity_namespace = xssFilters.inHTMLData(req.body._entity_namespace);

                    	req.tag._entity_namespace = _entity_namespace;
					}
