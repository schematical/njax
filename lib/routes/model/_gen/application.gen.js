            ...
            if(!req.application){
                ...
                //return next(new Error('Application not found'));
					...
					if(!_.isUndefined(req.body.namespace)){
                        var namespace = xssFilters.inHTMLData(req.body.namespace);

                    	req.application.namespace = namespace;
					}
					...
					if(!_.isUndefined(req.body.desc)){
                        var desc = xssFilters.inHTMLData(req.body.desc);

                    	req.application.desc = desc;
					}
                
            
                
					if(!_.isUndefined(req.body.app_url)){
                        var app_url = xssFilters.inHTMLData(req.body.app_url);

                    	req.application.app_url = app_url;
					}
                
            
                
					if(!_.isUndefined(req.body.domain)){
                        var domain = xssFilters.inHTMLData(req.body.domain);
					...
					if(!_.isUndefined(req.body.secret)){
                        var secret = xssFilters.inHTMLData(req.body.secret);

                    	req.application.secret = secret;
					}
                
            
                
					if(!_.isUndefined(req.body.level)){
                        var level = xssFilters.inHTMLData(req.body.level);

                    	req.application.level = level;
					}
                
            
                
					if(!_.isUndefined(req.body.callback_url)){
                        var callback_url = xssFilters.inHTMLData(req.body.callback_url);

                    	req.application.callback_url = callback_url;
					}
					...
					if(!_.isUndefined(req.body.auth_url)){
                        var auth_url = xssFilters.inHTMLData(req.body.auth_url);

                    	req.application.auth_url = auth_url;
					}
