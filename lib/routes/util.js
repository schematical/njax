    ...
    var route = app.njax.routes.util = {
        init:function(){
			...
			for(var i in app.njax.config.angular_sdk.modules){
				...
				var full_module_path = /*path.join(app.njax.env_config.app_dir,*/ module_path/*)*/;
            ...
            app.all(
                ...
                function(req, res, next){
					...
					for(var i in app.njax.config.angular_sdk.modules){
						var module_path = app.njax.config.angular_sdk.modules[i];
						var full_module_path = module_path;//path.join(/*app.njax.env_config.app_dir,*/ module_path);
