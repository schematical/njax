...
module.exports = function(app){
    ...
    eventSchema.virtual('uri').get(function(){
			 ...
			 eventSchema.virtual('visibility_tpcds').get(function(){
				return {
				...
				eventSchema.path('visibility').validate(function (value) {
                    if(
                    ...
                    return false;
  					//return /public|private/.test(value);
				}, 'Invalid visibility');

        
            eventSchema.virtual('is_public').get(function(){
                return (this.visibility == 'public');
            });
        
            eventSchema.virtual('is_private').get(function(){
   ...
   eventSchema.virtual('api_url').get(function(){
    ...
    eventSchema.options.toObject.transform = function (doc, ret, options) {
		...
		ret._njax_type = doc._njax_type;
                ...
                ret.visibility = doc.visibility;
                
                    ret.is_public = doc.is_public;
                
                    ret.is_private = doc.is_private;
