            ...
            if(!req.subscription){
                ...
                //return next(new Error('Subscription not found'));
					...
					if(!_.isUndefined(req.body.short_namespace)){
                    	...
                    	req.subscription.short_namespace = short_namespace;
					}
					...
					if(!_.isUndefined(req.body.entity_url)){
                    	...
                    	req.subscription.entity_url = entity_url;
					}
					...
					if(!_.isUndefined(req.body.entity_type)){
                    	...
                    	req.subscription.entity_type = entity_type;
					}
					...
					if(!_.isUndefined(req.body.entity_id)){
                    	...
                    	req.subscription.entity_id = entity_id;
					}
					...
					if(!_.isUndefined(req.body._entity_name)){
                    	...
                    	req.subscription._entity_name = _entity_name;
					}
					...
					if(!_.isUndefined(req.body._entity_namespace)){
                    	...
                    	req.subscription._entity_namespace = _entity_namespace;
					}
