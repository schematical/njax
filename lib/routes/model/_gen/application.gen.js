    ...
    var ObjectId = app.mongoose.Types.ObjectId;
     var route = app.njax.routes.application = {
        ...
        auth_update:function(req, res, next){
                ...
                if(req.user && (req.application && (req.application.owner.equals(req.user._id)) || (req.is_admin))){
        ...
        populate_list_query:function(req, res, next){
            ...
            var checkForHexRegExp = new RegExp("^[0-9a-fA-F]{24}$");
                    ...
                    if(req.query.app_url){
                        query['app_url'] =   { $regex: new RegExp('^' + req.query.app_url + '', 'i') };
                    }
                    ...
                    if(req.query.iframes){
                        query['iframes'] =   { $regex: new RegExp('^' + req.query.iframes + '', 'i') };
                    }
