        ...
        broadcast:function(accounts, event, data, application_id){
            ...
            async.series([
                ...
                function(cb){
                    ...
                    var eventObj = app.model.Event(eventData);
                    eventObj.accounts = [];
                ...
                function(cb){
					...
					if (accounts) {
						...
						njax_broadcast.sendToApplications(event, data, function(errs){
							return cb();
						});
					}
