...
var njax = function(options){
    options = _.extend(njax_config, env_config, options)
	if(!options.api && options.core.api){
		options.api = options.core.api;
	}
	var default_njax_config = require('./njax_config.js')();
	njax_config = _.extend(default_njax_config, njax_config);
    var app = njax_util.app(njax_config, options);
