        ...
        replaceTabUrlWithLocals:function(tabs, boostrap){
            ...
            for(var i in tabs){
                switch(tabs[i].action){
                    case('application_link'):
                        tabs[i].url = tabs[i].app_url + route.replaceWithLocals(tabs[i].url, boostrap);
                        console.log('application_link', tabs[i].url);
                        break;
                    case('external_link'):
                        tabs[i].url = route.replaceWithLocals(tabs[i].url, boostrap);
                        break;
                    case('relative_link'):
                        tabs[i].url = route.replaceWithLocals(tabs[i].url, boostrap);
                        break;
