		...
		extend: function (route) {
			...
			route.auth_update = function (req, res, next) {
				...
				route.bootstrap_edit = route.bootstrap_detail = function (req, res, next) {
					...
					res.bootstrap('tag_options', app.njax.env_config.developers.tag_options);


					res.bootstrap('iframes', app.njax.env_config.developers.iframes);
			...
			route.pre_update_save = function (req, res, next) {
				...
				/*if(!req.application.iframes || _.isArray(req.application.iframes)){
				 ...
				 res.bootstrap('iframes', _.clone(app.njax.env_config.developers.iframes));
			...
			var app_json_loc = app.njax.env_config.app_dir + '/apps.json';
